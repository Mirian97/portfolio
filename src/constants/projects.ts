...
const { mui, react, javascript, html, css, postgres, node, express, netlify } = skillIcons

const projects = [
  {
    name: 'Pigback Finance',
    image:
      'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQVtWMkcC0kW0jK5_6h7lzDAyApE7C7bXjm6yVmle5v&s',
